...
describe('/forgotpassword', () => {
    ...
    it('A registered email should be able to reset password/default language', (done) => {
        ...
        chai
            .request(server)
            .post('/api/v1/users1/forgotpassword')
            .send(email)
            .end((err, res) => {
...
describe('/resetpassword', () => {
    it('The password entered do not match/default language', (done) => {
        ...
        chai
            .request(server)
            .post('/api/v1/users1/reset/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Z7WHW7jw0p1nNDt5ewRv9vqZy-R4Q_RmF9ufdO6Aw0M')
            .send(user)
            .end((err, res) => {
