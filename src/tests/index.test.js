...
// chai.use(chaiHttp);
// var token ='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE2NTYwMDIzODUsImV4cCI6MTY1NjAwNTk4NX0.RTsbUEB9RZ3A2qmpKRrmgYPI67_ejeAKDQwDR_UdGLg'
...
//   it('it should return status 404 on wrong root', (done) => {
//         chai.request(server)
